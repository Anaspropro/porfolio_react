...
const Skills = () => {
  return (
    <section className="px-3 md:px-5 lg:px-12 py-4">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 md:py-8">
        <div className="flex gap-2 items-center">
          ...
          <div className="w-52 h-2 border border-yellow-600 items-center flex">
            <div className="w-48 h-2 bg-yellow-600"></div>  
          </div>
        </div>
